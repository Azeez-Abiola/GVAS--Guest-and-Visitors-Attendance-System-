      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">Monitor system activities and security events</p>
          </div>
          <button
            onClick={exportLogs}
          ...
          <TabGroup index={selectedTab} onIndexChange={setSelectedTab}>
            ...
            <TabPanels>
              ...
              <TabPanel>
                ...
                >
                  <Card className="p-6 shadow-lg border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                    {loading ? (
                      <div className="flex items-center justify-center py-12">
                        <div className="text-center">
                          <motion.div
                            className="animate-spin rounded-full h-12 w-12 border-b-2 border-slate-900 dark:border-white mx-auto mb-4"
                            animate={{ rotate: 360 }}
                            transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                          />
                          <Text className="text-slate-600 dark:text-gray-400 font-medium">Loading audit logs...</Text>
                        </div>
                      </div>
                      ...
                      <div className="overflow-x-auto">
                        <Table className="min-w-full">
                          <TableHead className="bg-gradient-to-r from-slate-100 to-slate-50 dark:from-slate-800 dark:to-slate-900">
                            <TableRow>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">Timestamp</TableHeaderCell>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">User</TableHeaderCell>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">Action</TableHeaderCell>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">Resource</TableHeaderCell>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">Severity</TableHeaderCell>
                              <TableHeaderCell className="font-semibold text-slate-800 dark:text-gray-200">Actions</TableHeaderCell>
                            </TableRow>
                          </TableHead>
                          <TableBody>
                            {filteredLogs.map(log => (
                              <TableRow key={log.id} className="hover:bg-blue-50 dark:hover:bg-slate-800 transition-colors">
                                <TableCell>
                                ...
                                <TableCell>
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <Text className="text-sm text-gray-900 dark:text-gray-200 font-medium">{log.user}</Text>
                                  </div>
                                </TableCell>
                                <TableCell>
                                  <div className="flex items-center space-x-2">
                                    {getActionIcon(log.action)}
                                    <Text className="text-sm text-gray-700 dark:text-gray-300 capitalize">{log.action.replace(/_/g, ' ')}</Text>
                                  </div>
                                </TableCell>
                                <TableCell>
                                  <Text className="text-sm text-gray-700 dark:text-gray-300">{log.resource}</Text>
                                </TableCell>
                                <TableCell>
              ...
              <TabPanel>
                <motion.div
                  ...
                  transition={{ delay: 0.2 }}
                >
                  <Card className="p-6 bg-gradient-to-br from-white to-red-50/30 dark:from-slate-900 dark:to-red-900/10 border-red-100 dark:border-red-900/30 shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 bg-red-500 rounded-lg">
                        <ExclamationTriangleIcon className="h-5 w-5 text-white" />
                      </div>
                      <Title className="text-red-900 dark:text-red-400">Security Events</Title>
                    </div>
                ...
                >
                  <Card className="p-6 bg-gradient-to-br from-white to-green-50/30 dark:from-slate-900 dark:to-green-900/10 border-green-100 dark:border-green-900/30 shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <Title className="text-green-900 dark:text-green-400">User Activity Summary</Title>
                    </div>
                    <div className="space-y-4">
                      {getUniqueUsers().map((user, index) => {
                        ...
                        return (
                          <motion.div
                            ...
                            transition={{ delay: index * 0.1 }}
                          >
                            <Card className="p-4 hover:shadow-md transition-shadow bg-white dark:bg-slate-800 border-green-100 dark:border-slate-700">
                              <Flex justifyContent="between" alignItems="center">
                                <div>
                                  <Text className="font-semibold text-gray-900 dark:text-white">{user}</Text>
                              ...
                              <div className="mt-3 space-y-2">
                                {userLogs.slice(0, 3).map(log => (
                                  <div key={log.id} className="flex items-center space-x-2 text-sm bg-green-50 dark:bg-slate-700 p-2 rounded-lg">
                                    {getActionIcon(log.action)}
                                    <Text className="text-gray-900 dark:text-gray-200 font-medium">{log.action.replace('_', ' ')}</Text>
                ...
                >
                  <Card className="p-6 bg-gradient-to-br from-white to-purple-50/30 dark:from-slate-900 dark:to-purple-900/10 border-purple-100 dark:border-purple-900/30 shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <Title className="text-purple-900 dark:text-purple-400">System Configuration Changes</Title>
                    </div>
                    <div className="space-y-4">
                      {filteredLogs
                        ...
                        .map((log, index) => (
                          <motion.div
                            ...
                            transition={{ delay: index * 0.1 }}
                          >
                            <Card className="p-4 hover:shadow-md transition-shadow bg-white dark:bg-slate-800 border-purple-100 dark:border-slate-700">
                              <div className="mb-3">
                                <Flex justifyContent="between" alignItems="start">
                                  <div>
                                    <Text className="font-semibold text-gray-900 dark:text-white">{log.action.replace('_', ' ').toUpperCase()}</Text>
                                    <Text className="text-sm text-gray-600 dark:text-gray-300">{log.details}</Text>
                                  </div>
