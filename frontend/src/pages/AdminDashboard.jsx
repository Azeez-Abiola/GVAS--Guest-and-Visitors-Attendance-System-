...
const AdminDashboard = () => {
  ...
  const handlePreRegister = async () => {
    try {
      const response = await ApiService.preRegisterVisitor(preRegisterData)
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Guest & Visitor Management System</p>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                  ...
                  <th className="text-left py-4 px-6 text-gray-700 font-semibold text-sm">Time</th>
            ...
            {!showGuestCode ? (
              ...
              <>
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-3 border-blue-200 rounded-2xl p-8 mb-6 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-blue-600"></div>
                    <div className="relative z-10">
                      <p className="text-sm text-blue-600 font-medium mb-2">GUEST ENTRY CODE</p>
                      <div className="text-4xl font-bold text-blue-700 mb-2 tracking-wider font-mono bg-white px-4 py-2 rounded-lg shadow-sm border">
                        {showGuestCode}
                      </div>
                  ...
                  <div className="space-y-3">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => {
                        navigator.clipboard.writeText(showGuestCode)
