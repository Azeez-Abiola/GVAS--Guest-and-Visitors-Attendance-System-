      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500">Manage restricted visitors and security alerts</p>
          </div>
          <button 
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all"
              />
            </div>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredBlacklist.map((item) => (
                <div key={item.id} className="group p-4 border border-red-100 bg-red-50/50 hover:bg-red-50 rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-sm text-gray-500">Added on {new Date(item.created_at).toLocaleDateString()}</span>
                      </div>
                  ...
                  <div className="flex items-center gap-3 pl-14 md:pl-0">
                    <button 
                      ...
                      className="text-sm font-medium text-gray-600 hover:text-gray-900 px-3 py-1.5 rounded-lg hover:bg-white transition-colors"
                    >
                      View Details
                    </button>
                    <button 
                      onClick={() => handleRevoke(item)}
                      className="text-sm font-medium text-red-600 hover:text-red-700 px-3 py-1.5 rounded-lg bg-white border border-red-200 hover:bg-red-50 transition-colors shadow-sm"
                    >
                      Revoke
                    </button>
                  </div>
                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">Restrict access for security purposes</p>
                      </div>
                      <button
                        onClick={() => setShowAddModal(false)}
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-red-600 text-sm font-medium">Blacklisted</p>
                        </div>
                      </div>
                      <button
                        onClick={() => setShowDetailsModal(false)}
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {selectedItem.id_number && (
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-900 font-medium">{selectedItem.id_number}</p>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Added</p>
                      ...
                      <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-gray-900 mb-1">Reason for Blacklisting</p>
                            <p className="text-gray-700 text-sm">{selectedItem.reason}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {selectedItem.notes && (
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                          <p className="font-semibold text-gray-900 mb-1 text-sm">Internal Notes</p>
