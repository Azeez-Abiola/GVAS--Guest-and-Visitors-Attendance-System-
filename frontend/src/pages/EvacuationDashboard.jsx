  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto p-6 print:p-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 print:hidden">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-900 dark:focus:border-slate-600 transition-all"
            />
          </div>
        ...
        {/* View Toggle */}
        <div className="mb-6 flex items-center space-x-2 print:hidden bg-white dark:bg-slate-800 p-1 rounded-xl border border-gray-200 dark:border-slate-700 w-fit shadow-sm">
          <button
            onClick={() => setGroupByFloor(true)}
            className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 text-sm ${groupByFloor
        ...
        {!loading && checkedInVisitors.length === 0 && (
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border-none ring-1 ring-gray-100 dark:ring-slate-700 p-12 text-center">
            <CheckCircle className="h-16 w-16 text-blue-500 mx-auto mb-4" />
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Building is Clear</h3>
            <p className="text-gray-500 dark:text-gray-400">No visitors currently checked in</p>
          </div>
        )}
          ...
          <div className="space-y-6">
            {floors.map(floor => (
              <motion.div
                ...
                className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border-none ring-1 ring-gray-100 dark:ring-slate-700 overflow-hidden"
              >
                <div className="bg-gray-50 dark:bg-slate-700 p-4 flex items-center justify-between border-b border-gray-100 dark:border-slate-600 print:bg-gray-100">
                  <div className="flex items-center space-x-3">
                    <div className="bg-white dark:bg-slate-600 p-2 rounded-lg shadow-sm">
                      <Building className="h-5 w-5 text-gray-700 dark:text-gray-200" />
                    </div>
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">
                      Floor {floor} - {visitorsByFloor[floor][0]?.tenant_name || 'Unknown Tenant'}
                    </h2>
                  </div>
                  <span className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-200 px-3 py-1 rounded-full text-sm font-bold border border-blue-200 dark:border-blue-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {visitorsByFloor[floor].map((visitor, index) => {
                      ...
                      return (
                        <div
                          key={visitor.id}
                          className={`rounded-xl p-4 border-2 transition-all print:break-inside-avoid ${isEvacuated
                              ? 'bg-green-50 dark:bg-green-900/20 border-green-300 dark:border-green-800'
                              : 'bg-white dark:bg-slate-700 border-gray-200 dark:border-slate-600 hover:border-blue-200 dark:hover:border-blue-700 hover:shadow-sm'
                            }`}
                        >
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-start space-x-3">
                              <button
                                ...
                                className={`p-2 rounded-lg transition-colors print:hidden ${isEvacuated ? 'bg-green-600 text-white' : 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/40'
                                  }`}
                              >
                              ...
                              <div className="print:ml-0">
                                <div className="flex items-center gap-2">
                                  <h3 className="font-bold text-gray-900 dark:text-white text-lg">{visitor.name}</h3>
                                  {isEvacuated && (
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">{visitor.company || 'No company'}</p>
                              </div>
                            </div>
                            {visitor.badge_number && (
                              <span className="bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 px-2.5 py-0.5 rounded-md text-xs font-bold border border-indigo-100 dark:border-indigo-800">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            <div>
                              <p className="text-gray-500 dark:text-gray-400 flex items-center text-xs mb-1">
                                <MapPin className="h-3 w-3 mr-1" />
                                Visitor ID
                              </p>
                              <p className="font-medium text-gray-900 dark:text-gray-200">{visitor.visitor_id}</p>
                            </div>
                            <div>
                              <p className="text-gray-500 dark:text-gray-400 flex items-center text-xs mb-1">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-gray-900 dark:text-gray-200">{visitor.host_name || 'N/A'}</p>
                            </div>
                            <div>
                              <p className="text-gray-500 dark:text-gray-400 flex items-center text-xs mb-1">
                              ...
                              <p className="font-medium text-gray-900 dark:text-gray-200">{visitor.phone || 'N/A'}</p>
                            </div>
                          </div>
                        </div>
                      )
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider print:hidden">Status</th>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Floor</th>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Check-in Time</th>
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-slate-700">
                  {filteredVisitors.map((visitor, index) => {
                    ...
                    return (
                      <tr
                        key={visitor.id}
                        className={`transition-colors print:break-inside-avoid ${isEvacuated ? 'bg-green-50 dark:bg-green-900/20' : 'hover:bg-gray-50/50 dark:hover:bg-slate-700/50'
                          }`}
                      >
                        <td className="px-6 py-4 print:hidden">
                          <button
                            onClick={() => toggleEvacuated(visitor.id)}
                            className={`p-1.5 rounded-lg transition-colors ${isEvacuated ? 'bg-green-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'
                              }`}
                          >
                            {isEvacuated ? <CheckCircle className="h-4 w-4" /> : <User className="h-4 w-4" />}
                          </button>
                        </td>
                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 text-sm">{index + 1}</td>
                        ...
                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 font-mono text-xs">{visitor.visitor_id}</td>
                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 text-sm">{visitor.company || 'N/A'}</td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 text-sm">{visitor.host_name || 'N/A'}</td>
                        <td className="px-6 py-4">
                          {visitor.badge_number ? (
                            <span className="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-2.5 py-0.5 rounded-md text-xs font-medium border border-indigo-100 dark:border-indigo-800">
                              {visitor.badge_number}
                            </span>
                          ) : (
                        ...
                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 text-sm">
                          <div>
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500">{visitor.email || 'N/A'}</p>
                          </div>
                        </td>
                      </tr>
                    )
