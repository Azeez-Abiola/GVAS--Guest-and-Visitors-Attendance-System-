        ...
        {selectedHost ? (
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="font-semibold text-gray-900 dark:text-white">{selectedHost.name}</div>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute z-50 mt-2 w-full bg-white dark:bg-slate-900 border-2 border-gray-200 dark:border-slate-700 rounded-xl shadow-2xl max-h-96 overflow-hidden"
            >
              {/* Search Bar */}
              <div className="sticky top-0 bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-800 dark:to-slate-900 p-4 border-b-2 border-gray-100 dark:border-slate-700">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-800 border-2 border-gray-200 dark:border-slate-700 text-gray-900 dark:text-white rounded-lg focus:border-slate-900 dark:focus:border-slate-500 focus:ring-4 focus:ring-slate-100 dark:focus:ring-slate-800 outline-none transition-all"
              ...
              <div className="overflow-y-auto max-h-80 custom-scrollbar">
                {hostsByFloor.length === 0 ? (
                  ...
                  hostsByFloor.map(([floor, floorHosts]) => (
                    <div key={floor} className="border-b border-gray-100 dark:border-slate-800 last:border-b-0">
                      {/* Floor Header */}
                      <div className="sticky top-0 bg-gray-50 dark:bg-slate-800 px-4 py-2 flex items-center gap-2 border-b border-gray-200 dark:border-slate-700">
